...
filename = os.path.join(__dir__, 'shrek.PNG')
swamp_filename = os.path.join(__dir__, 'swamp.jpg')
img = PIL.Image.open(filename)
swamp = PIL.Image.open(swamp_filename)
...
canvas = Canvas(root, height=1200, width=1200, bg='green')
